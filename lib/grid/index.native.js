...
var _index = require('../carousel/index.native');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('../flex/index.native');

var _index4 = _interopRequireDefault(_index3);

var _index5 = require('./style/index.native');

var _index6 = _interopRequireDefault(_index5);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var GridStyles = _reactNative.StyleSheet.create(_index6['default']); /* tslint:disable:jsx-no-multiline-js */
        ...
        value: function render() {
            ...
            var renderItem = this.props.renderItem || function (dataItem, index) {
                return _react2['default'].createElement(
                    ...
                    _react2['default'].isValidElement(dataItem.icon) ? dataItem.icon : _react2['default'].createElement(_reactNative.Image, { source: { uri: dataItem.icon }, style: [styles.icon,iconStyle] }),
            ...
            var flexItemStyle = this.getFlexItemStyle(columnNum);
            var rowsArr = [];
                ...
                var _loop = function _loop(j) {
                    ...
                    if (dataIndex < dataLength) {
                        ...
                        rowArr.push(_react2['default'].createElement(
                            ...
                            { key: j, style: [styles.grayBorderBox, flexItemStyle, { borderLeftWidth: hasLine && j === 0 ? _reactNative.StyleSheet.hairlineWidth : 0 }, customItemStyle], onPress: function onPress() {
            ...
            if (isCarousel && pageCount > 1) {
                for (var pageIndex = 0; pageIndex < pageCount; pageIndex++) {
                    ...
                    for (var ii = 0; ii < carouselMaxRow; ii++) {
                        ...
                        if (rowIndex < rowCount) {
                            ...
                            pageRows.push(_react2['default'].createElement(
                                _index4['default'],
                                { key: rowIndex, style: [styles.grayBorderBox, { borderBottomWidth: hasLine ? _reactNative.StyleSheet.hairlineWidth : 0 }] },
                                res
                            ));
                        }
                    }
                    pagesArr.push(_react2['default'].createElement(
                        _reactNative.View,
                        { key: pageIndex, style: [styles.grayBorderBox, { borderTopWidth: hasLine && pageIndex !== 0 ? _reactNative.StyleSheet.hairlineWidth : 0 }] },
                        pageRows
                    ));
                }
            }
