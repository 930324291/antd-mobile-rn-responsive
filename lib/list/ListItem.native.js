    ...
    (0, _createClass3['default'])(Item, [{
        ...
        value: function render() {
            var _a = this.props,
                ...
                align = _a.align,
                restProps = __rest(_a, ["styles", "children", "multipleLine", "thumb", "extra", "arrow", "style", "onClick", "onPressIn", "onPressOut", "wrap", "disabled", "align","last","thumbStyle"]);
            ...
            var itemView = _react2['default'].createElement(
                ...
                typeof thumb === 'string' ? _react2['default'].createElement(_reactNative.Image, { source: { uri: thumb }, style: [itemStyles.Thumb, multipleLine && itemStyles.multipleThumb,thumbStyle] }) : thumb,
                _react2['default'].createElement(
                    _reactNative.View,
                    { style: [ multipleLine && itemStyles.multipleLine, multipleLine && alignStyle,last?itemStyles.ItemPadding:itemStyles.Line] },
                    contentDom,
                    extraDom,
