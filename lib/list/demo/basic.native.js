...
var Item = _antdMobileRn.List.Item; /* tslint:disable:jsx-no-multiline-js */
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            Item,
            { extra: _react2['default'].createElement(_reactNative.Image, { source: {
                  uri: 'https://os.alipayobjects.com/rmsportal/mOoPurdIfmcuqtr.png'
                }, style: { width: 29, height: 29 } }), arrow: 'horizontal' },
            'extra\u4E3AImage'
          )
        )
      );
