...
var AgreeItem = _antdMobileRn.Checkbox.AgreeItem; // tslint:disable:jsx-no-multiline-js

var CheckboxItem = _antdMobileRn.Checkbox.CheckboxItem;
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          _reactNative.View,
          { style: { padding: 10 } },
          _react2['default'].createElement(_antdMobileRn.Checkbox, { checked: this.state.checkBox1, style: { tintColor: '#f00' }, onChange: function onChange(event) {
              _this2.setState({ checkBox1: event.target.checked });
            } }),
          _react2['default'].createElement(_antdMobileRn.WhiteSpace, null),
          _react2['default'].createElement(
            _antdMobileRn.Checkbox,
            null,
            'Checkbox'
          ),
          _react2['default'].createElement(_antdMobileRn.WhiteSpace, null),
          _react2['default'].createElement(_antdMobileRn.Checkbox, { checked: true, disabled: true }),
          _react2['default'].createElement(_antdMobileRn.WhiteSpace, null),
          _react2['default'].createElement(_antdMobileRn.Checkbox, { disabled: true })
        ),
        _react2['default'].createElement(_antdMobileRn.WhiteSpace, null),
        _react2['default'].createElement(
          AgreeItem,
