    ...
    (0, _createClass3['default'])(IConDemo, [{
        ...
        value: function render() {
            var data = list.map(function (item) {
                return {
                    icon: _react2['default'].createElement(_antdMobileRn.Icon, { type: item }),
                    text: item
                };
            }).concat([{
                icon: _react2['default'].createElement(_antdMobileRn.Icon, { type: '\uE601', size: 55, color: 'red' }),
                text: 'Customized'
            }]);
            return _react2['default'].createElement(_antdMobileRn.Grid, { data: data, columnNum: 3, hasLine: false });
        }
    }]);
    return IConDemo;
