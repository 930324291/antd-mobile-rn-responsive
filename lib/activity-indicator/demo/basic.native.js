  ...
  (0, _createClass3['default'])(ActivityIndicatorExample, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              _antdMobileRn.Flex.Item,
              null,
              _react2['default'].createElement(_antdMobileRn.ActivityIndicator, null)
            )
          )
        ),
        _react2['default'].createElement(_antdMobileRn.WhiteSpace, { size: 'xl', style: { backgroundColor: '#fff' } }),
        _react2['default'].createElement(
          _antdMobileRn.WingBlank,
          null,
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              _antdMobileRn.Flex.Item,
              null,
              _react2['default'].createElement(_antdMobileRn.ActivityIndicator, { text: 'Loading...' })
            )
          )
        ),
        _react2['default'].createElement(_antdMobileRn.WhiteSpace, { size: 'xl', style: { backgroundColor: '#fff' } }),
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                _reactNative.View,
                { style: [styles.darkBg] },
                _react2['default'].createElement(_antdMobileRn.ActivityIndicator, { color: '#fff' })
              )
            )
          )
        ),
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              _antdMobileRn.Flex.Item,
              null,
              _react2['default'].createElement(_antdMobileRn.ActivityIndicator, { size: 'large' })
            )
          )
        ),
        _react2['default'].createElement(_antdMobileRn.WhiteSpace, { size: 'xl', style: { backgroundColor: '#fff' } }),
        ...
        _react2['default'].createElement(_antdMobileRn.ActivityIndicator, { animating: this.state.animating, toast: true, size: 'large', text: 'Loading...' })
      );
    }
  }]);
