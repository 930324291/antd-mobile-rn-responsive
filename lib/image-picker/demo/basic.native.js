    ...
    (0, _createClass3['default'])(ImagePickerExample, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_antdMobileRn.ImagePicker, { onChange: this.handleFileChange, files: this.state.files }),
                _react2['default'].createElement(_antdMobileRn.WhiteSpace, null),
                _react2['default'].createElement(_antdMobileRn.ImagePicker, { onChange: this.handleFile2Change, files: this.state.files2 })
            );
        }
    }]);
