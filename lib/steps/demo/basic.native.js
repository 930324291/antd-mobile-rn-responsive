...
var Step = _antdMobileRn.Steps.Step; /* tslint:disable:jsx-no-multiline-js */
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(Step, { key: 2, title: 'Wait', description: 'This is description', status: 'wait', icon: _react2['default'].createElement(_antdMobileRn.Icon, { type: 'down', size: 20, color: 'white' }) })
            )
          )
        )
      );
