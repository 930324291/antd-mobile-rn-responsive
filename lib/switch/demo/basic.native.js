        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    { extra: _react2['default'].createElement(_antdMobileRn.Switch, { checked: true }) },
                    'On(controlled)'
                ),
                _react2['default'].createElement(
                    _antdMobileRn.List.Item,
                    { extra: _react2['default'].createElement(_antdMobileRn.Switch, null) },
                    'Off(controlled)'
                ),
                _react2['default'].createElement(
                    _antdMobileRn.List.Item,
                    { extra: _react2['default'].createElement(_antdMobileRn.Switch, { checked: this.state.checked, onChange: this.onSwitchChange }) },
                    'onChange event, switch status: ',
                    this.state.checked ? 'open' : 'close'
                ),
                _react2['default'].createElement(
                    _antdMobileRn.List.Item,
                    { extra: _react2['default'].createElement(_antdMobileRn.Switch, { disabled: true }) },
                    'disabled'
                ),
                _react2['default'].createElement(
                    _antdMobileRn.List.Item,
                    { extra: _react2['default'].createElement(_antdMobileRn.Switch, { color: 'red', checked: true }) },
                    'color'
                )
            );
        }
