...
var RadioItem = _antdMobileRn.Radio.RadioItem; /* tslint:disable:jsx-no-multiline-js */
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(_antdMobileRn.Radio, { checked: this.state.part1Value === 2, onChange: function onChange(event) {
                            if (event.target.checked) {
