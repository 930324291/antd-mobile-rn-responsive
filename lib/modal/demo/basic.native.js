...
var BasicModalExample = function (_React$Component) {
    ...
    function BasicModalExample(props) {
        ...
        _this.onButtonClick = function () {
            _antdMobileRn.Modal.alert('Title', 'alert content', [{ text: 'Cancel', onPress: function onPress() {
        ...
        _this.onButtonClick2 = function () {
            _antdMobileRn.Modal.operation([{ text: '标为未读', onPress: function onPress() {
        ...
        _this.onButtonClick3 = function () {
            _antdMobileRn.Modal.prompt('Login', 'Pleas input login information', function (login, password) {
        ...
        _this.onButtonClick4 = function () {
            _antdMobileRn.Modal.prompt('Input password', 'password message', function (password) {
                return console.log('password: ' + password);
            }, 'secure-text', 'defaultValue');
        };
        _this.onButtonClick5 = function () {
            _antdMobileRn.Modal.prompt('Name', 'name message', function (password) {
                return console.log('password: ' + password);
