...
var Item = _antdMobileRn.Popover.Item;
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        _antdMobileRn.Popover,
                        { name: 'm', style: { backgroundColor: '#eee' }, overlay: overlay, contextStyle: styles.contextStyle
                            // tslint:disable-next-line:jsx-no-multiline-js
                            , overlayStyle: [styles.overlayStyle, _reactNative.Platform.OS === 'android' && styles.androidOverlayStyle], triggerStyle: styles.triggerStyle, onSelect: this.onSelect },
                        _react2['default'].createElement(
                            _reactNative.Text,
                            null,
                            '\u83DC\u5355'
