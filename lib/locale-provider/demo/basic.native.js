...
var Page = function Page() {
    return _react2['default'].createElement(
        _reactNative.View,
        null,
        _react2['default'].createElement(_antdMobileRn.Pagination, { total: 5, current: 1 }),
        _react2['default'].createElement(_antdMobileRn.WhiteSpace, null),
        _react2['default'].createElement(
            _antdMobileRn.List,
            { style: { backgroundColor: 'white' } },
            _react2['default'].createElement(
                _antdMobileRn.DatePicker,
            ...
            _react2['default'].createElement(_antdMobileRn.WhiteSpace, null),
            _react2['default'].createElement(_antdMobileRn.SearchBar, { placeholder: 'Search', showCancelButton: true })
        )
    );
};
